import { placeFor } from '../data/routes/africa-stories.js?v=pocket-2';
import { ROUTES } from '../data/routes/index.js?v=pocket-2';
import { ITEMS,itemById,BAG_LIMIT,HAND_LIMIT } from '../data/items.js?v=pocket-2';
import { CONTACTS,SOCIAL_PROMPT } from '../data/contacts.js?v=pocket-2';
import { ENDINGS,returnQuestions } from '../data/endings.js?v=pocket-2';
import * as E from './engine.js?v=pocket-2';
import { drawMap,drawMiniMap,africaHitPath,scene,avatar } from './art.js?v=pocket-2';
